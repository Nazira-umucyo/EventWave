...
export default function SelectInterestScreen() {
  ...
  const handleNext = () => {
    authStore.completeInterests(selected);
  ...
  return (
    <SafeAreaView style={styles.root} edges={['top', 'bottom']}>
          ...
          return (
            <Pressable
              ...
              <View style={[styles.tileIcon, active && styles.tileIconActive]}>
                <Ionicons name={category.icon as any} size={26} color={active ? Colors.primary : Colors.textMuted} />
              </View>
      ...
      <View style={styles.footer}>
        <AppButton label="Next" variant="dark" onPress={handleNext} disabled={selected.length === 0} />
      </View>
    </SafeAreaView>
  );
}
