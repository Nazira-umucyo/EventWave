...
export const events: EventItem[] = [
  {
    ...
    ticketTiers: [
      ...
      { id: 'economy', label: 'Economy Ticket', price: 20, seatsAvailable: 120 },
    ],
    latitude: 23.793,
    longitude: 90.404,
  },
  ...
  },
  {
    ...
    ticketTiers: [{ id: 'economy', label: 'Standard Ticket', price: 10, seatsAvailable: 60 }],
  },
  {
    ...
    ticketTiers: [{ id: 'economy', label: 'Standard Ticket', price: 15, seatsAvailable: 45 }],
  },
  {
    ...
    price: 28,
    currency: 'USD',
    description: 'A city-wide cooking competition featuring local chefs and food trucks.',
    organizerId: 'u-tamim',
    membersJoinedAvatars: memberAvatars,
    membersJoinedCount: 320,
    ticketTiers: [{ id: 'economy', label: 'Entry Ticket', price: 28, seatsAvailable: 80 }],
  },
  {
    ...
    price: 9,
    currency: 'USD',
    description: 'The season-ending championship match at the Uttara sports complex.',
    organizerId: 'u-tamim',
    membersJoinedAvatars: memberAvatars,
    membersJoinedCount: 410,
    ticketTiers: [{ id: 'economy', label: 'Standard Ticket', price: 9, seatsAvailable: 150 }],
  },
  {
    ...
    price: 30,
    currency: 'USD',
    description: 'Freestyle motorbike stunt riders show off tricks in an open-air arena.',
    organizerId: 'u-tamim',
    membersJoinedAvatars: memberAvatars,
    membersJoinedCount: 95,
    ticketTiers: [{ id: 'economy', label: 'Standard Ticket', price: 30, seatsAvailable: 70 }],
  },
  {
    ...
    price: 12,
    currency: 'USD',
    description: 'A showcase of international touring acts performing one night only.',
    organizerId: 'u-tamim',
    membersJoinedAvatars: memberAvatars,
    membersJoinedCount: 500,
    ticketTiers: [{ id: 'economy', label: 'Standard Ticket', price: 12, seatsAvailable: 200 }],
  },
  {
    id: 'e-football-final',
    ...
    price: 10,
    currency: 'USD',
    description: 'Local league final — two unbeaten sides face off for the title.',
    organizerId: 'u-tamim',
    membersJoinedAvatars: memberAvatars,
    membersJoinedCount: 610,
    ticketTiers: [{ id: 'economy', label: 'Standard Ticket', price: 10, seatsAvailable: 300 }],
  },
];

export const getEventById = (id: string | undefined) => events.find((e) => e.id === id);
